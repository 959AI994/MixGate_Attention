...
from .dg_model_mig_rexmg import Model as DeepGate_Mig
from .dg_model_xmg_rexmg import Model as DeepGate_Xmg
    ...
    def forward(self, G, node_lutid_map={}):
        ...
        if self.args.hier_tf:
            ...
            for batch_id in range(G.batch.max().item() + 1): 
                ...
                batch_xmg_tokens = xmg_tokens[G.batch == batch_id]
