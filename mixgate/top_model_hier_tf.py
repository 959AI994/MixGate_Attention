...
class TopModel(nn.Module):
    ...
    def forward(self, G):
        ...
        if self.args.hier_tf:
            ...
            # ⬇️
            mcm_predicted_tokens, attention_info = self.mask_tf(G, tokens, masked_tokens, masked_modal=selected_modality)
            # ⬆️
        ...
        return mcm_predicted_tokens, mask_indices, selected_tokens, masked_prob, aig_prob, mig_prob, xmg_prob, xag_prob,attention_info
